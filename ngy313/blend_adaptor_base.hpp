...
struct blend_adaptor {
  ...
  struct result {
    typedef detail::blend_adaptor_base<typename detail::copy_argument<
                                           Signature>::type,
                                       SrcBlendTag,
                                       DestBlendTag> type;
  };
  ...
  detail::blend_adaptor_base<Drawable, SrcBlendTag, DestBlendTag> operator ()(
      const Drawable &drawable) const {
    return detail::blend_adaptor_base<Drawable, SrcBlendTag, DestBlendTag>(
               drawable);
  }
};
}